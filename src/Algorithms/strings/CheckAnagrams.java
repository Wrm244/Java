...
/**
 * Two Algorithms.strings are anagrams if they are made of the same letters arranged differently (ignoring the
 * case).
 */
public class CheckAnagrams {
    ...
    /**
     * Check if two Algorithms.strings are anagrams or not
     *
